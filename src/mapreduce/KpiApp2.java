...
{
	static final String INPUT_PATH = "hdfs://wyl:9000/wlan1";
	static final String OUT_PATH = "hdfs://wyl:9000/out4";
...
class KpiWritable2 implements Writable
{
	...
	public KpiWritable2(String upPackNum, String downPackNum, String upPayLoad,
			String downPayLoad)
	{
